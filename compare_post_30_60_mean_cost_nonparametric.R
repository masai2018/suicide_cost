...
sc_int_smy <- c((sc_int$days), quantile(sc_int$days, 0.95),
...
for(i in c("all","ip", "op", "ed", "ed_only","ip_only", "op_only", "ed_ip_only","ip_op_only", "ed_op_only",
  ...
  tmp[, group := paste0(GENDER_CODE, "-", age_group )]
  cat(paste0("post 30, cost type: ", i, 
             ", compare mean cost of age and gender groups:", "\n"))
  print((kruskal.test(post_30 ~ group, data = tmp)))
  cat(paste0("post 60, cost type: ", i, 
             ", compare mean cost of age and gender groups:", "\n"))
  print((kruskal.test(post_60 ~ group, data = tmp)))
  ...
  #   print((kruskal.test(post_30 ~ GENDER_CODE, data = tmp)))
  #   tmp <- smy[age %in% ages]
  #   cat(paste0("post 60, cost type: ", i, ", age range: ", ages[1], "-", ages[length(ages)],
  #              ", compare mean cost of male and female:", "\n"))
  #   print((kruskal.test(post_60 ~ GENDER_CODE, data = tmp)))
  # }
  ...
  #   print((kruskal.test(post_30 ~ age_group, data = tmp)))
  #   cat(paste0("post 60, cost type: ", i, ", gender: ", gender1,
  #              ", compare mean cost of age groups:", "\n"))
  #   print((kruskal.test(post_60 ~ age_group, data = tmp)))
  # }
}
